...
document.addEventListener('DOMContentLoaded', () => {
	const botoFS = document.getElementById('botoFS') as HTMLButtonElement | null;
	const iconEnter = document.getElementById('icon-enter') as SVGElement | null;
	const iconExit = document.getElementById('icon-exit') as SVGElement | null;

	if (!botoFS || !iconEnter || !iconExit) return;
