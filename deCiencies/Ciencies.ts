 ...
 * 							12.4 Km --> 1.240e+4 m
 */
function convertidor(valor: string, uni1: string, uni2: string) {
  // Definim variables
 ...
 */
function interseccio(rect1: string, rect2: string) {}

// Hacer funciones globalmente disponibles
declare global {
  interface Window {
    imc: typeof imc;
    convertidor: typeof convertidor;
    bigFloat: typeof bigFloat;
    interseccio: typeof interseccio;
  }
}
