...
import { netejarSVG, crearGrupInvertit, afegirRectangle, afegirText, } from "./lib/gestionarSVG.js";
...
function afegirMedia() {
    ...
    medias.forEach((media) => {
        ...
        const barraMultimedia = new BarraMultimedia(media, media.parentElement || undefined);
    });
}
/**********************************************************
 * NOTES
...
function posarNotes() {
    ...
    afegirText(g, posX[4] + 1.5, // centrat
    -2, // a sobre (invertit)
    "0", {
        "font-size": "2px",
        "text-anchor": "middle",
    ...
    // Crida la funció actualitzar()
    if (typeof actualitzar === "function")
        actualitzar();
}
/**
...
function actualitzar() {
    ...
    const uf1 = Number((_a = document.getElementById("uf1")) === null || _a === void 0 ? void 0 : _a.value) || 0;
    const uf2 = Number((_b = document.getElementById("uf2")) === null || _b === void 0 ? void 0 : _b.value) || 0;
    const uf3 = Number((_c = document.getElementById("uf3")) === null || _c === void 0 ? void 0 : _c.value) || 0;
    const uf4 = Number((_d = document.getElementById("uf4")) === null || _d === void 0 ? void 0 : _d.value) || 0;
    // Ponderacions
    const p1 = 35, p2 = 38, p3 = 50, p4 = 42;
    const totalP = p1 + p2 + p3 + p4;
    // Mitjana ponderada
    const mitjana = (uf1 * p1 + uf2 * p2 + uf3 * p3 + uf4 * p4) / totalP;
    // Escala d'ampliació
    const ampliacio = Number((_e = document.getElementById("ampliacio")) === null || _e === void 0 ? void 0 : _e.value) ||
        1;
    // Posicions X dels rectangles
    const posX = [1, 5, 9, 13, 21];
...
function ordenar() {
    ...
    const divAudio = Array.from(document.querySelectorAll("div")).find((div) => div.querySelector("audio"));
    // Buscar el primer div que contingui un <video>
    const divVideo = Array.from(document.querySelectorAll("div")).find((div) => div.querySelector("video"));
    ...
    if (divAudio && divVideo && divAudio !== divVideo) {
        ...
        (_a = divAudio.parentNode) === null || _a === void 0 ? void 0 : _a.insertBefore(divVideo, divAudio.nextSibling);
    }
}
/**********************************************************
 * INICIALITZACIÓ
