 ...
 */
export function crearGrupInvertit(svg, translateY) {
 ...
 */
export function afegirRectangle(grup, x, y, width, height, attrs) {
 ...
 */
export function afegirText(grup, x, y, text, attrs) {
 ...
 */
export function netejarSVG(element) {
